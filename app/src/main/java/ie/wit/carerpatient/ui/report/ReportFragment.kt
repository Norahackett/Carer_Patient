...
class ReportFragment : Fragment(), CarerPatientClickListener {
    ...
    override fun onCreateView(
        ...
        reportViewModel.observableMedicinesList.observe(viewLifecycleOwner, Observer { medicines ->
            medicines?.let {
    ...
    private fun setupMenu() {
        (requireActivity() as MenuHost).addMenuProvider(object : MenuProvider {
            ...
            override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
                ...
                val toggleMedicines: SwitchCompat =
    ...
    private fun render(medicinesList: ArrayList<CarerPatientModel>) {
        fragBinding.recyclerView.adapter = CarerPatientAdapter(
            medicinesList, this,
